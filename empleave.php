...
<html>
<head>
	<title>Employee Leave | Admin Panel | Sarkin Mota</title>
	...
	<div id="divimg">
		<table>
			...
			<?php
				...
				$start = strtotime($employee['start']);
$end   = strtotime($employee['end']);
$days  = ($end - $start) / (60 * 60 * 24); // difference in days
echo "<td>".$days."</td>";
